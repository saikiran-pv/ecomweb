class ProductsController < ApplicationController
  ...
  def create
    @product = Product.create(product_name: params[:product_name], price: params[:price], description: params[:description], discount: params[:discount], visibility: params[:visibility], rating: params[:rating], image: params[:image], code: params[:code])
    if @product.save
